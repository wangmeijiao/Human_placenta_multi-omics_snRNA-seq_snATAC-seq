...
#dar_overlap_p2g
region_df = pd.read_csv('../dar_overlap_p2g/regionset_dar.split.filterp2g.df.bed',sep='\t',header=0) #50377
  # 24066 cluster1
  #   328 cluster2
  #  1428 cluster3
  #   654 cluster4
...
region_df.columns = ['chr','start','end','peakid','cid']
...
work_dir = 'result_pycisTarget_p2g_auc0.005'
...
region_set_pr_dict = {'dar_ttest_rawstrict.filtersharedc3c5.p2g': region_set_pr}
...
menr_ctx = menr['CTX_dar_ttest_rawstrict.filtersharedc3c5.p2g_All']
